...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8034f3eb5d6f64fcba791816959500100a68a92e98d15d884100c4590f83f2f1.js',function(){input.required=false;search();});}
