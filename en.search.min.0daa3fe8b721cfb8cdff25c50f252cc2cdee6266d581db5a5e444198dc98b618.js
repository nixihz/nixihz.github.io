...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f3d309b6a28cf155d92ed4578a67ca9dd5a121664732f94223a4d4089478eebc.js',function(){input.required=false;search();});}
