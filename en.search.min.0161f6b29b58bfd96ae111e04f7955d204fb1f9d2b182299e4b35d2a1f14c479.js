...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.91a850f5c22788cbd6dbed1c616cb976cd2a94493a7deda708aaefdb8743d9e0.js',function(){input.required=false;search();});}
