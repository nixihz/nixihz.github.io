...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.63557adebdf10dba726a49a68320cd112f56dd46cef5110a8e2991570b499ccb.js',function(){input.required=false;search();});}
