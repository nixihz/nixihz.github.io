...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.df815f90fb7cbb6bbcf2cf47c17773d9d8a8b633513e2c023be46c1456d98fb6.js',function(){input.required=false;search();});}
