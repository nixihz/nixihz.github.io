...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1ffbb20cc2b69923a78a0021e2792c23054971ee22d2704e8d1a31f0dd9d75fc.js',function(){input.required=false;search();});}
