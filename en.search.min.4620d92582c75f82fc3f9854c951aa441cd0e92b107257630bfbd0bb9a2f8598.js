...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7a0d2fa601cedee744995a5f067131c2091d45c99ea78b266348f474aa52fcbd.js',function(){input.required=false;search();});}
