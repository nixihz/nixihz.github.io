...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1fa6fa026d91d9c2ed8c046997432a46eddbdbf9bc32d5b012494034420020fd.js',function(){input.required=false;search();});}
