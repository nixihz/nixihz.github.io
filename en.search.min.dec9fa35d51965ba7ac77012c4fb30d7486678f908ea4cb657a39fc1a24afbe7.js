...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4050a08ff3a629d406a03a2acd20ccc2b0dfea9a03a2e37b8ef7f56fddebe981.js',function(){input.required=false;search();});}
